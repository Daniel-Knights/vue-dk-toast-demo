<template>
  <main id="content">
    ...
    <div class="property">
      ...
      />
      <p>
        Any valid HTML can go here. Fontawesome and Material Icons are loaded into this
        demo, give it a try:
    ...
    <div class="property">
      ...
      />
      <p>
        Add a type of <code class="code-note">error</code> to make the background red and
        text white:
      ...
      <p>
        Or a type of <code class="code-note">success</code> to make the background green
        and text white:
      ...
      <p>
        Or a type of <code class="code-note">passive</code> to make the background blue
        and text white:
    ...
    <div class="property">
      ...
      <select
        @change="
          $emit('update:disableClick', $event.target.value === 'true' ? true : false)
        "
      >
    ...
    <div class="property">
      ...
      <div class="full-width">
        ...
        <select
          @change="
            $emit('update:targetBlank', $event.target.value === 'true' ? true : false)
          "
        >
          <option value="true">true</option>
          <option value="false" selected>false</option>
